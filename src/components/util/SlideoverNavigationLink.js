    ...
    return (
        <li className="py-1 border-b last:border-b-0 border-gray-600">
            <div className="flex items-center">
                ...
                <div onClick={handleClick} role="button" aria-label="menu-button" tabIndex="0" className={`w-0 h-0 border-8 ml-2 ${isToggled ? "transform rotate-180 mb-2" : "mt-3"}`} style={{borderColor: "transparent", borderTopColor: "yellow"}}></div>
            </div>
